    ...
    IDisposable
{
    ...
    readonly List<(Uri PartUri, string ContentType)> contentTypes = new();
    readonly List<(string Id, Uri TargetUri, string RelationshipType, TargetMode TargetMode)> packageRelationships = new();
